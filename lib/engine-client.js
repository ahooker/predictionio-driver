...
Engine.prototype.sendQuery = function (options, callback) {
	return request.postAsync({forever: true, url: this.queryUrl, strictSSL: this.options.strictSSL !== undefined ? this.options.strictSSL : true, body: JSON.stringify(options)}).
